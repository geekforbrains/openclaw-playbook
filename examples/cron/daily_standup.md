...
Run the morning standup and post to the team channel.
...
Keep it tight — under 10 lines on a normal day:

**Daily Standup**

**1. Project Pulse** (one line each, active projects only)
- Status emoji + project name + what moved + what's next
- e.g. `🟢 myproject — shipped mobile nav refactor. Next: gameplay loop PR review.`
- Paused projects only surface if something changed

**2. Blockers** 🚧
- Anything stuck or waiting on the user — explicit asks, not vague flags
